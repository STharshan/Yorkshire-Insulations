...
export const serviceWorkflowData = {
  loftInsulation: {
    ...
    relatedServices: [
      { title: "Spray Foam Removal", href: "/spray-foam-removal" },
      { title: "Underfloor Insulation", href: "/underfloor-insulation" },
    ],
  ...
  cavityWallInsulation: {
    ...
    relatedServices: [
      { title: "Loft Insulation", href: "/loft-insulation" },
      { title: "Underfloor Insulation", href: "/underfloor-insulation" },
    ],
  ...
  sprayFoamRemoval: {
    ...
    relatedServices: [
      { title: "Loft Insulation", href: "/loft-insulation" },
      { title: "New Build Insulation", href: "/new-build-insulation" },
    ],
  ...
  underfloorInsulation: {
    ...
    relatedServices: [
      { title: "Loft Insulation", href: "/loft-insulation" },
      { title: "Cavity Wall Insulation", href: "/cavity-wall-insulation" },
    ],
